      ...
      try {
        ...
        var data = JSON.stringify({
          ...
          template_params: {
            ...
            from_name: "Expozy Blog",
            message: `Thanks ${newName} for placing an order. https://expozy.com`,
            to_name: newName,
            subject: "You have created a order at Expozy Blog.!",
          },
        });
        res.status(200).json({
          success: true,
