...
export default function LivePreview() {
  ...
  return (
    <>
      <Head>
        <title>Live Preview | Expozy Blog</title>
        <meta charSet="utf-8" />
        <meta name="twitter:card" content="app" />
        <meta name="twitter:site" content="https://www.expozy.com/" />
        <meta name="twitter:creator" content="@handle" />
        <meta property="og:type" content="website" />
        <meta property="og:locale" content="en_IE" />
        <meta property="og:site_name" content="Expozy Blog" />
        <title>Expozy Blog</title>
        <meta
          name="robots"
