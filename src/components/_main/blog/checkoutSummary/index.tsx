import React, { useEffect, useState } from 'react'; // Importing useEffect from React
import dynamic from "next/dynamic";
import { fetchSettings } from 'lib/dbConnect';
  ...
  return (
    <RootStyled>
      <CardHeader
        ...
        title={blogPost ? blogPost : ""} // Render the title dynamically
        action={
          enableEdit && (
